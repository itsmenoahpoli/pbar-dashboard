...
const StaffAccountsManagePage: React.FC = () => {
  const { isLoading, data, refetch } = useQuery({
    queryKey: ["accounts-staffs"],
  ...
  return (
    <>
      <PageHeader title="Staff Accounts" subtitle="Manage all staff accounts" breadcrumbs={["Manage Staff Accounts"]}></PageHeader>

      <div className="px-5">
        <Card className="w-full min-h-[100px] flex flex-col gap-7">
          <div className="flex flex-row justify-between">
            <div className="w-full">
              <h1 className="font-bold">Staff Accounts List</h1>
            </div>
...
export default StaffAccountsManagePage;
